...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Obtén el correo electrónico del usuario desde el Intent
        val email = intent.extras?.getString("user") ?: "Usuario no identificado"

        // Muestra el correo electrónico del usuario en el TextView
